...
<?php
	...
	<div class="panel-body easypiechart-panel">
						...
						<div class="easypiechart" id="easypiechart-orange"
							data-percent="<?php echo $sum_yesterday_expense;?>">
							<span class="percent">
			<?php
    ...
    ?>
					<div class="panel-body easypiechart-panel">
						...
						<div class="easypiechart" id="easypiechart-teal"
							data-percent="<?php echo $sum_weekly_expense;?>">
    ...
    ?>
					<div class="panel-body easypiechart-panel">
						...
						<div class="easypiechart" id="easypiechart-red"
							data-percent="<?php echo $sum_monthly_expense;?>">
							<span class="percent">
							<?php
    ...
    ?>
					<div class="panel-body easypiechart-panel">
						<h4>今年掲示板登録</h4>
						<div class="easypiechart" id="easypiechart-red"
							data-percent="<?php echo $sum_yearly_expense;?>">
							<span class="percent"><?php
